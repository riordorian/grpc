...
func (_m *GetListHandlerInterface) Handle(ctx context.Context, req dto.ListRequest) ([]news.New, error) {
...
func (_c *GetListHandlerInterface_Handle_Call) Run(run func(ctx context.Context, req dto.ListRequest)) *GetListHandlerInterface_Handle_Call {
...
func (_c *GetListHandlerInterface_Handle_Call) RunAndReturn(run func(context.Context, dto.ListRequest) ([]news.New, error)) *GetListHandlerInterface_Handle_Call {
	_c.Call.Return(run)
	return _c
}
