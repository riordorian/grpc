...
func (_m *ListRequestConvertorInterface) Convert(_a0 *grpc.ListRequest) (dto.ListRequest, error) {
	ret := _m.Called(_a0)
	...
	var r0 dto.ListRequest
	var r1 error
	if rf, ok := ret.Get(0).(func(*grpc.ListRequest) (dto.ListRequest, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*grpc.ListRequest) dto.ListRequest); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(dto.ListRequest)
	}
...
func (_c *ListRequestConvertorInterface_Convert_Call) Return(_a0 dto.ListRequest, _a1 error) *ListRequestConvertorInterface_Convert_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ListRequestConvertorInterface_Convert_Call) RunAndReturn(run func(*grpc.ListRequest) (dto.ListRequest, error)) *ListRequestConvertorInterface_Convert_Call {
	_c.Call.Return(run)
	return _c
}
