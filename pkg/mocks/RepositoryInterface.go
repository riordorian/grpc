...
func (_m *RepositoryInterface) GetList(ctx context.Context, request structures.ListRequest) ([]news.New, error) {
...
//   - ctx context.Context
//   - request structures.ListRequest
...
func (_c *RepositoryInterface_GetList_Call) Run(run func(ctx context.Context, request structures.ListRequest)) *RepositoryInterface_GetList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RepositoryInterface_GetList_Call) RunAndReturn(run func(context.Context, structures.ListRequest) ([]news.New, error)) *RepositoryInterface_GetList_Call {
	_c.Call.Return(run)
	return _c
}
